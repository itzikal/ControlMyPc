...
public class SearchNearByHostsActivity extends AppCompatActivity
{
    private static final String LOG_TAG = SearchNearByHostsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_search_near_by_hosts);


        RecyclerView list = (RecyclerView) findViewById(R.id.list);
        list.setLayoutManager(new LinearLayoutManager(SearchNearByHostsActivity.this));
